...
extension NSPredicateEditorRowTemplate {
    ...
    var initialValue: Any? {
        get { associatedValue(for: "initialValue", initial: nil) }
     ...
     */
    convenience init(compoundTypes: [NSCompoundPredicate.LogicalType], initialValue: NSCompoundPredicate.LogicalType? = nil) {
     ...
     */
    convenience init(constant title: String, values: [Any], initialValue: Any? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .notEqualTo]) {
    ...
    /**
     ...
     - Returns: A row template initialized for displaying compound predicates with constant values.
     */
    convenience init(constant titles: [String], values: [Any], initialValue: Any? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .notEqualTo]) {
     ...
     */
    convenience init(string title: String, initialValue: String? = nil, operators: [NSComparisonPredicate.Operator] = [.matches, .contains, .beginsWith, .endsWith, .equalTo, .notEqualTo], options: NSComparisonPredicate.Options = [.caseInsensitive, .diacriticInsensitive]) {
    ...
    /**
     ...
     - Returns: A row template initialized for displaying compound predicates with string values.
     */
    convenience init(string titles: [String], initialValue: String? = nil, operators: [NSComparisonPredicate.Operator] = [.matches, .contains, .beginsWith, .endsWith, .equalTo, .notEqualTo], options: NSComparisonPredicate.Options = [.caseInsensitive, .diacriticInsensitive]) {
     ...
     */
    convenience init(bool title: String, initialValue: Bool? = nil) {
    ...
    /**
     ...
     - Returns: A row template initialized for displaying compound predicates with a Boolean value.
     */
    convenience init(bool titles: [String], initialValue: Bool? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .lessThan, .greaterThan, .notEqualTo]) {
     ...
     */
    convenience init(integer title: String, initialValue: Int? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .lessThan, .greaterThan, .notEqualTo]) {
    ...
    /**
     ...
     - Returns: A row template initialized for displaying compound predicates with Integer values.
     */
    convenience init(integer titles: [String], initialValue: Int? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .lessThan, .greaterThan, .notEqualTo]) {
     ...
     */
    convenience init(date title: String, initialValue: Date? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .lessThan, .greaterThan, .notEqualTo]) {
    ...
    /**
     ...
     - Returns: A row template initialized for displaying compound predicates with date values.
     */
    convenience init(date titles: [String], initialValue: Date? = nil, operators: [NSComparisonPredicate.Operator] = [.equalTo, .lessThan, .greaterThan, .notEqualTo]) {
