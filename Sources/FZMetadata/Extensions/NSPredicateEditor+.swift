...
extension NSPredicateEditor {
     ...
     */
    convenience init (rowTemplates: [NSPredicateEditorRowTemplate], @RowTemplateBuilder displayingRowTemplates: () -> [NSPredicateEditorRowTemplate]) {
        self.init()
     ...
     */
    func displayRowTemplates(@RowTemplateBuilder _ rowTemplates: () -> [NSPredicateEditorRowTemplate]) {
...
extension NSPredicateEditorRowTemplate {
    static func && (lhs: NSPredicateEditorRowTemplate, rhs: NSPredicateEditorRowTemplate) -> NSPredicateEditorRowTemplate {
