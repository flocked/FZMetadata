...
public class MetadataItem {
    ...
    public var url: URL? {
        ...
        return self.value(for: \.url)
    }
    
    /// The full path to the file.
    public var path: String? {
        get { self.value(for: \.path) } }
    ...
    internal var fileSizeBytes: Int? {
        get { self.value(for: \.fileSizeBytes) } }
    ...
    public var fileIsInvisible: Bool? {
        get { self.value(for: \.fileIsInvisible) } }
    
    /// Indicates whether the file is invisible.
    public var fileExtensionIsHidden: Bool? {
        get { self.value(for: \.fileExtensionIsHidden) } }
    
    /// The type of the file.
    public var fileType: FileType? {
        get {  if let contentTypeTree: [String] = self.value(for: \.contentTypeTree) {
    ...
    public var lastUsageDates: [Date]? {
        get { self.value(for: \.lastUsageDates) }
    ...
    public var metadataModificationDate: Date? {
        get { self.value(for: \.metadataModificationDate) }
    ...
    public var contentCreationDate: Date? {
        get { self.value(for: \.contentCreationDate) }
    ...
    public var contentChangeDate: Date? {
        get { self.value(for: \.contentChangeDate) }
    ...
    public var directoryFilesCount: Int? {
        get { self.value(for: \.directoryFilesCount) } }
    ...
    public var finderComment: String? {
        get { self.value(for: \.finderComment) } }
    
    /// Finder tags for this file.
    public var finderTags: [String]? {
        get { self.value(for: \.finderTags)?.compactMap({$0.replacingOccurrences(of: "\n6", with:"")}) }
        set { 
            if let url = url {
                url.resources.tags = newValue ?? []
            } else {
                self.setExplicity(\.finderTags, to: newValue?.compactMap({$0 + "\n6"}))
            }
        }
    }
    
    internal var finderPrimaryTagColorIndex: Int? {
        get { self.value(for: \.finderPrimaryTagColorIndex) } }
    ...
    public var hasCustomIcon: Bool? {
        get { self.value(for: \.hasCustomIcon) } }
    
    /// The usage count of the file.
    public var usageCount: Int? {
        get { if let useCount = self.value(for: \.usageCount) {
            return useCount - 2
        }
            return nil
        } }
    ...
    public var audiences: [String]? {
        get { self.value(for: \.audiences) } }
    
    /// Extent or scope of the content of the document.
    public var coverage: [String]? {
        get { self.value(for: \.coverage) } }
    ...
    public var projects: [String]? {
        get { self.value(for: \.projects) } }
    
    /// Number of pages in the document.
    public var numberOfPages: Double? {
        get { self.value(for: \.numberOfPages) } }
    ...
    public var country: String? {
        get { self.value(for: \.country) }
        set { self.setExplicity(\.country, to: newValue) } }
        
    /// City of the self.
    public var city: String? {
        get { self.value(for: \.city) }
    ...
    public var longitude: Double? {
        get { self.value(for: \.longitude) } }
    
    /// The speed of the item, in kilometers per hour.
    public var speed: Double? {
        get { self.value(for: \.speed) } }
    ...
    public var musicalGenre: String? {
        get { self.value(for: \.musicalGenre) } }
    ...
    public var isGeneralMidiSequence: Bool? {
        get { self.value(for: \.isGeneralMidiSequence) } }
    ...
    public var appleLoopsRootKey: String? {
        get { self.value(for: \.appleLoopsRootKey) } }
    ...
    public var authorEmailAddresses: [String]? {
        get { self.value(for: \.authorEmailAddresses) } }
    
    // Addresses for authors of this self.
    public var authorAddresses: [String]? {
        get { self.value(for: \.authorAddresses) } }
    
    /// Recipients of this self.
    public var recipients: [String]? {
        get { self.value(for: \.recipients) } }
    ...
    public var queryContentRelevance: Double? {
        get { self.value(for: \.queryContentRelevance) } }
}
...
public extension MetadataItem {
    ...
    func getExplicity<V: Any, K: KeyPath<MetadataItem, V?>>(_ keyPath: K) -> V? {
        let key = "com.apple.metadata:" + keyPath.mdItemKey
        return self.url?.extendedAttributes[key]
    }
