...
extension MetadataQuery {
    ...
    /**
     ...
     Each attribute/value tuple contains the attribute name, the value, and the number of instances of that value that exist for the attribute name.
     
     To get the attribute/value tuples mapped to the attributes value type, use MetadataItem's key path. For example:
     
     ```swift
     /// This returns [MappedAttributeValueTuple<Date?>]
