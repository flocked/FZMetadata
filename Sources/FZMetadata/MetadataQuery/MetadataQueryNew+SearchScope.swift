//
//  MetadataQueryNew+SearchScope.swift
//
//
...
import Foundation
    ...
    public extension MetadataQueryNew {
        ...
        enum SearchScope: String {
            ...
            public var rawValue: String {
                switch self {
                case .ubiquitousDocuments: return NSMetadataQueryNewUbiquitousDocumentsScope
                case .ubiquitousData: return NSMetadataQueryNewUbiquitousDataScope
                case .accessibleUbiquitousExternalDocuments: return NSMetadataQueryNewAccessibleUbiquitousExternalDocumentsScope
                }
            }
        }
    }
