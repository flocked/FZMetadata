//
//  MetadataQueryNew+SortDescriptor.swift
//
//
...
/**
 ...
 - Parameter attribute: The comparable metadata attribute.
 */
public prefix func >> (attribute: MetadataItem.Attribute) -> MetadataQueryNew.SortDescriptor {
    MetadataQueryNew.SortDescriptor(key: attribute.rawValue, ascending: true)
}
 ...
 */
public prefix func << (attribute: MetadataItem.Attribute) -> MetadataQueryNew.SortDescriptor {
    MetadataQueryNew.SortDescriptor(key: attribute.rawValue, ascending: false)
}
